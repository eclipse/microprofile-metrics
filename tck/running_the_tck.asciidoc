    ...
    <plugins>
        ...
        <plugin>
            ...
            <configuration>
                ...
                <!-- THE FOLLOWING TEST WILL TEST AN IMPLEMENTATION AGAINST THE OPTIONAL REST STAT METRICS -->
                <!-- KEEP DISABLED/EXCLUDED IF NOT TESTING FOR COMPLIANCE WITH OPTIONAL REST STAT METRICS  -->
                 <excludes>
...
If an implementation supports REST stat metrics, remove the `<exclude>**/MpMetricOptionalTest.java</exclude>` to enable
the relevant TCK tests.
