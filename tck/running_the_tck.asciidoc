...
=== Additional Configuration for Optional TCK

Add the the  `<dependency>org.eclipse.microprofile.metrics:microprofile-metrics-optional-tck</dependency>` element to the `<dependenciesToScan>` element:
