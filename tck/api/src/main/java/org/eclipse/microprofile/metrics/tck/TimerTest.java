...
//		System.out.println("DEBUG: (count / (beforeUptime)) " + (1 / (beforeUptime)));
//		System.out.println("DEBUG: (count / (afterUptime) " + (1 / (afterUptime)));
...
//		System.out.println("DEBUG: test " + delta);
	...
	public void testSnapshotValues() throws Exception {
		Assert.assertArrayEquals("The globalTimer does not contain the expected values: " + Arrays.toString(sampleLongData), sampleLongData, globalTimer.getSnapshot().getValues());
	}
