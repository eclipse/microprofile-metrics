...
|@ParallelCounted | M, C, T | Denotes a counter, which counts the parallel invocations of the annotated object. This type of counter also keeps an internal high water mark.| MetricUnits.NONE
