...
If the metric annotation is placed on a class, then for each method, the metric name will be:

|===
| | `name` is specified | `name` is not specified
| `absolute=true` | `<value-of-name-argument>.<name-of-the-method>` | `<short-name-of-class>.<name-of-the-method>`
| `absolute=false` | `<package-of-the-class>.<value-of-name-argument>.<name-of-the-method>` | `<canonical-name-of-the-class>.<name-of-the-method>`
|===
