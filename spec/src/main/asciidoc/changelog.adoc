...
* Changes in 2.0
** icon:bolt[role="red"] Refactoring of Counters, as the old `@Counted` was misleading in practise.
...
** `Metadata` is now immutable and built via a <<pgm-metadata,`MetadataBuilder`>>.
