...
** meter: a metric which counts occurrences of something, measures mean throughput and one-, five-, and fifteen-minute exponentially-weighted moving average throughput.
...
* Scope always starts the metric name.
...
It will be possible to use the non-annotations API, but using the annotations will generally be easier and preferred by developers.
