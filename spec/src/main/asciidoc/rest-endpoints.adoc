...
----
{
  "simple_responseTime": {
    ...
    "maxTimeDuration": 3231000000,
    "minTimeDuration": 25600000
  }
}
----
...
application_response_time_maxTimeDuration_seconds  3.231000000
# TYPE application_response_time_minTimeDuration_seconds gauge
application_response_time_minTimeDuration_seconds  0.0256
----
