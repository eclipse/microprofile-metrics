...
* The application name will be provided as tag `_app=<name>` if <<app-multi-app,multiple applications>> are deployed in the server.
  See below for handling of tags.
...
==== Handling of multiple apps

The application name will be provided as tag `_app=<name>` if <<app-multi-app,multiple applications>> are deployed in the server.
See the next section for handling of tags.
